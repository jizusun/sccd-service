...
Select customer
    ...
    Click element in incident create page    //section[contains(@id,"dialog-cont")]//li[contains(@id,"clone")][1]
...
Select system
    ...
    Sleep    8s
    Execute Javascript    document.getElementById("__splitter0-content-0").scrollTop = 800
...
Select component
    ...
    Sleep    3s
    Execute Javascript    document.getElementById("__splitter0-content-0").scrollTop = 9999
    Sleep    2s
...
Select SFSF component
    Click element in incident create page    css=span[id*=subProSel-vhi]
    Click element in incident create page    contactViewDynamic--AllCloudFilter
    Click element in incident create page    css=li[id*=subProductAllList-0]

Select GIGYA component
    Click element in incident create page    css=span[id*=compInput-vhi]
    Click element in incident create page    contactViewDynamic--GigyaFilter
    Wait until element enabled and type text    contactViewDynamic--componentSearchField-I    xx-ser-sapsmp-test
    Sleep    10s
    Click element in incident create page    css=div[id=contactViewDynamic--componentSearchList] li:first-child
